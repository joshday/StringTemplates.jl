...
#-----------------------------------------------------------------------------# StringTemplates
@info "Benchmarking StringTemplates..."
...
function results(i)
    ...
    println("In benchmark $i, StringTemplates is $(round(r.time, digits=1)) times faster than Mustache.")
    println("In benchmark $i, StringTemplates is $(round(r2.time, digits=1)) times faster than Base string interpolation.")
end
